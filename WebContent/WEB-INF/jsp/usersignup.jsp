...
<div class="row">
	...
	<p>If you already have account with us, please login at the <a href="user/signin.html">login page</a></p>
	<br></br>
	<form action="http://demo-opencart.expresspixel.com/index.php?route=account/register" class="form-horizontal" role="form" method="post">
		<div class="panel panel-default">
			<div class="panel-body">
				...
				<div class="form-group ">
					<label class="col-sm-3 control-label"><span class="required">*</span>Telephone:</label>
					<div class="col-sm-9">
						<input class="form-control" name="telephone" value="" type="text">
					</div>
				</div>
		...
		<div class="panel panel-default">
			<div class="panel-body">
				...
				<div class="form-group">
					...
					<div class="col-sm-9"><input class="form-control" name="company" value="" type="text"></div>
				</div>			

				<div class="form-group" style="display: none;">
					<label class="col-sm-3 control-label"><span class="required">*</span>Business Type:</label>
				...
				<div class="form-group " id="company-id-display">
					<label class="col-sm-3 control-label"><span style="display: none;" id="company-id-required" class="required">*</span> Company ID:</label>
					<div class="col-sm-9">
						<input class="form-control" name="company_id" value="" type="text">
					</div>
				</div>		
	
				<div style="display: none;" class="form-group " id="tax-id-display">
					<label class="col-sm-3 control-label"><span id="tax-id-required" class="required">*</span> Tax ID:</label>
					<div class="col-sm-9">
						<input class="form-control" name="tax_id" value="" type="text">
					</div>
				</div>
				...
				<div class="form-group ">
					...
					<div class="col-sm-9">
						<input class="form-control" name="address_1" value="" type="text">
					</div>
				</div>
				...
				<div class="form-group ">
					...
					<div class="col-sm-9">
						<input class="form-control" name="address_2" value="" type="text">			
					</div>
				</div>
				...
				<div class="form-group ">
					...
					<div class="col-sm-9">
						<input class="form-control" name="postcode" value="" type="text">	
					</div>
				</div>

			<div class="form-group ">
				<label class="col-sm-3 control-label"><span class="required">*</span> Country:</label>
				<div class="col-sm-9"><select class="form-control" name="country_id">
	...
	<div class="panel panel-default">
		<div class="panel-body">			
			...
			<div class="form-group ">
				...
				<div class="col-sm-9">
					<input class="form-control" name="confirm" value="" type="password">	
				</div>
			</div>
